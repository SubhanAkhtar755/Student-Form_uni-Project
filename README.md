...
1. Clone this repository  
   ```bash
   git clone https://github.com/SubhanAkhtar755/Student-Form_uni-Project.git
   cd Student-Form_uni-Project
...
Add your Firebase config to the JavaScript file (usually app.js or main.js):
